...
img_1_m = cv2.medianBlur(img,5)
plt.subplot(333),plt.imshow(img_1,cmap = 'gray')
plt.title('Blur Image'), plt.xticks([]), plt.yticks([])

edges = cv2.Canny(img_1_m,200,300)
...
plt.subplot(335),plt.imshow(img_1,cmap = 'gray')
...
plt.subplot(336),plt.imshow(img,cmap = 'gray')
...
plt.subplot(338),plt.imshow(img_1,cmap = 'gray')
